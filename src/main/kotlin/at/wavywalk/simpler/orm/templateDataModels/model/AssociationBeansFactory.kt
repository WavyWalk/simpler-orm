...
object AssociationBeansFactory {
    ...
    private fun buildHasManyAsPolymorphicAssociationBean(
        ...
        associationBean.polymorphicTypeField = FieldBeansUtils.getFieldBeanByName(
            associationBean.associatedModelDataModel.fieldBeans,
            annotation.polymorphicTypeField
        )
    ...
    private fun buildBelongsToPolymorphicAssociationBean(
        ...
        val beanToReturn =  AssociationBean(
                ...
                fieldOnThis = FieldBeansUtils.getFieldBeanByName(modelDataModel.fieldBeans, fieldOnThisName),
                fieldOnThat = FieldBeansUtils.getFieldBeanByName(
                    firstModel.fieldBeans,
                    fieldOnThatName
                ) //fieldOnThat should be of same type on all models so first's is used
        )
        beanToReturn.associatedPolymorphicModelDataModels = associatedPolymorphicModelDataModels
        beanToReturn.polymorphicTypeField =
                FieldBeansUtils.getFieldBeanByName(modelDataModel.fieldBeans, polymorphicTypeFieldName)
        return beanToReturn
    }
